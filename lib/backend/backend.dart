...
import 'schema/hoteles_record.dart';
...
export 'schema/hoteles_record.dart';
...
/// Functions to query HotelesRecords (as a Stream and as a Future).
Future<int> queryHotelesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      HotelesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<HotelesRecord>> queryHotelesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<HotelesRecord>> queryHotelesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<HotelesRecord>> queryHotelesRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
