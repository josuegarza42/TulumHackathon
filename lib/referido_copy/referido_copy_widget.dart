...
import 'referido_copy_model.dart';
export 'referido_copy_model.dart';
...
class _ReferidoCopyWidgetState extends State<ReferidoCopyWidget>
    with TickerProviderStateMixin {
  late ReferidoCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReferidoCopyModel());
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Text(
                                                'Recomiendo apliamente este hotel, si lo contratas con mi codigo puedes obtener un 10% de descuento',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium,
                                              ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Image.asset(
                                      'assets/images/Group_690_(1).png',
                                      width: 100.0,
                                      height: 100.0,
              ...
              if (FFAppState().visible4 == true)
                Column(
                  ...
                  children: [
                                      ...
                                      children: [
                                        FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            setState(() {
                                              FFAppState().visible5 = true;
                                            });
                                            if (animationsMap[
                                                    'columnOnActionTriggerAnimation5'] !=
                                                null) {
                                              setState(() =>
                                                  hasColumnTriggered5 = true);
                                              SchedulerBinding.instance
                                                  .addPostFrameCallback((_) async =>
                                                      await animationsMap[
                                                              'columnOnActionTriggerAnimation5']!
                    ...
                    animationsMap['columnOnActionTriggerAnimation4']!,
                    hasBeenTriggered: hasColumnTriggered4),
              if (FFAppState().visible5 == true)
                InkWell(
                  splashColor: Colors.transparent,
                  focusColor: Colors.transparent,
                  hoverColor: Colors.transparent,
                  ...
                  onTap: () async {
                    setState(() {
                      FFAppState().visible5 = false;
                    });
                    if (animationsMap['columnOnActionTriggerAnimation5'] !=
                        null) {
                  ...
                  child: Column(
                    ...
                    animationsMap['columnOnActionTriggerAnimation5']!,
                    hasBeenTriggered: hasColumnTriggered5),
            ],
          ),
        ),
      ),
