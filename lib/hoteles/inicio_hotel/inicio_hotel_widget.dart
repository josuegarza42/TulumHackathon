...
import 'inicio_hotel_model.dart';
export 'inicio_hotel_model.dart';

class InicioHotelWidget extends StatefulWidget {
  const InicioHotelWidget({Key? key}) : super(key: key);

  @override
  _InicioHotelWidgetState createState() => _InicioHotelWidgetState();
}

class _InicioHotelWidgetState extends State<InicioHotelWidget>
    with TickerProviderStateMixin {
  late InicioHotelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InicioHotelModel());
