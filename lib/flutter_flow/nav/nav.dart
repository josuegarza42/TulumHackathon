...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'registrateP2',
          path: '/registrateP2',
          builder: (context, params) => RegistrateP2Widget(),
        ),
        FFRoute(
          name: 'Perfil',
          path: '/perfil',
        ...
        FFRoute(
          name: 'registrateP1',
          path: '/registrateP1',
          builder: (context, params) => RegistrateP1Widget(),
        ),
        FFRoute(
          name: 'hoteleroP3',
          path: '/hoteleroP3',
        ...
        FFRoute(
          name: 'Crea_Hotel',
          path: '/creaHotel',
          builder: (context, params) => CreaHotelWidget(),
        ),
        FFRoute(
          name: 'Pago',
          path: '/pago',
        ...
        FFRoute(
          name: 'Referido',
          path: '/referido',
          builder: (context, params) => ReferidoWidget(),
        ),
        FFRoute(
          name: 'InicioHotelCopy2',
        ...
        FFRoute(
          name: 'Hospedaje',
          path: '/hospedaje',
          builder: (context, params) => HospedajeWidget(),
        ),
        FFRoute(
          name: 'fecha',
          path: '/fecha',
